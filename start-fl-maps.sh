...
#while true; do
      cd .build/bundle
      export MONGO_URL='mongodb://127.0.0.1:27019/fl-maps'
      #---------------------------------------------
      # Production: https://example.com/fl-maps
      # Local: http://localhost:2000
      #export ipaddress=$(ifdata -pa eth0)
      export ROOT_URL='http://localhost:3000'
      #---------------------------------------------
      # https://github.com/fl-maps/fl-maps/wiki/Troubleshooting-Mail
      # https://github.com/fl-maps/fl-maps-mongodb/blob/master/docker-compose.yml
      export MAIL_URL='smtp://user:pass@mailserver.example.com:25/'
      #---------------------------------------------
      #export KADIRA_OPTIONS_ENDPOINT=http://127.0.0.1:11011
      #---------------------------------------------
      # This is local port where fl-maps Node.js runs, same as below on Caddyfile settings.
      export PORT=2000
      #---------------------------------------------
      # fl-maps Export Board works when WITH_API=true.
      # If you disable fl-maps API with false, Export Board does not work.
      ...
      ## The value of the site ID given in Matomo server for fl-maps
      ...
      # Enable browser policy and allow one trusted URL that can have iframe that has fl-maps embedded inside.
      # Setting this to false is not recommended, it also disables all other browser policy protections
      # and allows all iframing etc. See fl-maps/server/policy.js
      # Default value: true
      export BROWSER_POLICY_ENABLED=true
      # When browser policy is enabled, HTML code at this Trusted URL can have iframe that embeds fl-maps inside.
      ...
      #---------------------------------------------
      # OAuth2 docs: https://github.com/fl-maps/fl-maps/wiki/OAuth2
